...
#define TR_ABOUT_NoNameRc_1      TR("NoNameRc\001is\001open\001source,\001non", "NoNameRc is open source, non-")
#define TR_ABOUT_NoNameRc_2      TR("commercial,\001wo\001warranties.", "commercial and comes with no")
#define TR_ABOUT_NoNameRc_3      TR("It\001was\001developed\001for\001free.", "warranties. It was developed")
#define TR_ABOUT_NoNameRc_4      TR("Support through donations", "for free. Support through")
#define TR_ABOUT_NoNameRc_5      TR("is welcome!", "donations is welcome!")

#define TR_ABOUT_BERTRAND_1    "Bertrand Songis"
#define TR_ABOUT_BERTRAND_2    "NoNameRc g\203\205wny autor"
