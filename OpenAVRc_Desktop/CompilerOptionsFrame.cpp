...
CompilerOptionsFrame::CompilerOptionsFrame(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
  ...
  SetClientSize(wxSize(789,365));
  Panel1 = new wxPanel(this, ID_PANEL1, wxPoint(0,0), wxSize(819,368), wxTAB_TRAVERSAL, _T("ID_PANEL1"));
  ...
  Panel2 = new wxPanel(Notebook1, ID_PANEL2, wxDefaultPosition, wxSize(784,345), wxTAB_TRAVERSAL, _T("ID_PANEL2"));
  StaticBox13 = new wxStaticBox(Panel2, ID_STATICBOX13, _("Manches"), wxPoint(648,8), wxSize(128,128), 0, _T("ID_STATICBOX13"));
  CheckBoxInvStickLH = new wxCheckBox(Panel2, ID_CHECKBOX3, _("Inversion Stick_LH"), wxPoint(656,32), wxSize(112,16), 0, wxDefaultValidator, _T("ID_CHECKBOX3"));
  CheckBoxInvStickLH->SetValue(false);
  CheckBoxInvStickRH = new wxCheckBox(Panel2, ID_CHECKBOX8, _("Inversion Stick_RH"), wxPoint(656,104), wxSize(112,16), 0, wxDefaultValidator, _T("ID_CHECKBOX8"));
  ...
  CheckBoxPPM_LIMITS_SYMETRICAL = new wxCheckBox(Panel2, ID_CHECKBOX17, _("PPM Simm limits"), wxPoint(512,296), wxSize(120,16), 0, wxDefaultValidator, _T("ID_CHECKBOX17"));
  ...
  CheckBoxPPM_CENTER_ADJUSTABLE = new wxCheckBox(Panel2, ID_CHECKBOX16, _("PPM Center adjust"), wxPoint(512,272), wxSize(120,16), 0, wxDefaultValidator, _T("ID_CHECKBOX16"));
  ...
  ChoicePPM_UNIT  = new wxChoice(Panel2, ID_CHOICE4, wxPoint(320,296), wxSize(112,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE4"));
  ...
  ChoicePCB = new wxChoice(Panel2, ID_CHOICE6, wxPoint(96,32), wxSize(96,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE6"));
  ChoicePCB->SetSelection( ChoicePCB->Append(_("MEGAMINI")) );
  ChoicePCB->SetToolTip(_("Type de radio"));
  ChoiceLCD = new wxChoice(Panel2, ID_CHOICE1, wxPoint(96,72), wxSize(96,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE1"));
  ...
  ChoiceVOICE = new wxChoice(Panel2, ID_CHOICE3, wxPoint(96,144), wxSize(96,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE3"));
  ...
  CheckBoxAUDIO = new wxCheckBox(Panel2, ID_CHECKBOX7, _("Audio"), wxPoint(96,184), wxSize(104,16), 0, wxDefaultValidator, _T("ID_CHECKBOX7"));
  CheckBoxAUDIO->SetValue(false);
  CheckBoxAUDIO->SetToolTip(_("Option audio"));
  CheckBoxHAPTIC = new wxCheckBox(Panel2, ID_CHECKBOX14, _("Haptic"), wxPoint(96,224), wxSize(104,16), 0, wxDefaultValidator, _T("ID_CHECKBOX14"));
  CheckBoxHAPTIC->SetValue(false);
  CheckBoxHAPTIC->SetToolTip(_("Option Vibreur"));
  CheckBoxHELI = new wxCheckBox(Panel2, ID_CHECKBOX1, _("HELI"), wxPoint(512,152), wxSize(120,16), 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
  CheckBoxHELI->SetValue(false);
  CheckBoxHELI->SetToolTip(_("Option hélicoptère"));
  CheckBoxTEMPLATES = new wxCheckBox(Panel2, ID_CHECKBOX15, _("TEMPLATES"), wxPoint(512,176), wxSize(120,16), 0, wxDefaultValidator, _T("ID_CHECKBOX15"));
  CheckBoxTEMPLATES->SetValue(false);
  CheckBoxTEMPLATES->SetToolTip(_("Option modèles pré programmés"));
  CheckBoxSD_CARD = new wxCheckBox(Panel2, ID_CHECKBOX12, _("Carte SD"), wxPoint(96,264), wxSize(104,16), 0, wxDefaultValidator, _T("ID_CHECKBOX12"));
  CheckBoxSD_CARD->SetValue(false);
  CheckBoxSD_CARD->SetToolTip(_("Option carte SD (Sauvegarde - Fichiers log)"));
  ChoiceTRANSLATIONS = new wxChoice(Panel2, ID_CHOICE7, wxPoint(320,32), wxSize(40,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE7"));
  ...
  ChoiceTTS = new wxChoice(Panel2, ID_CHOICE5, wxPoint(320,72), wxSize(40,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE5"));
  ...
  ChoiceNAVIGATION = new wxChoice(Panel2, ID_CHOICE8, wxPoint(320,248), wxSize(112,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE8"));
  ...
  StaticText7 = new wxStaticText(Panel2, ID_STATICTEXT7, _("Navigation"), wxPoint(224,256), wxSize(88,16), wxALIGN_RIGHT, _T("ID_STATICTEXT7"));
  ButtonEXIT = new wxButton(Panel2, ID_BUTTON3, _("Sauvegarder et sortir"), wxPoint(648,240), wxSize(128,23), 0, wxDefaultValidator, _T("ID_BUTTON3"));
  ButtonCOMPILE = new wxButton(Panel2, ID_BUTTON2, _("Compiler"), wxPoint(648,200), wxSize(128,23), 0, wxDefaultValidator, _T("ID_BUTTON2"));
  ChoiceUNITS = new wxChoice(Panel2, ID_CHOICE9, wxPoint(512,32), wxSize(80,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE9"));
  ...
  ChoiceDEFAULT_MODE = new wxChoice(Panel2, ID_CHOICE10, wxPoint(512,72), wxSize(40,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE10"));
  ...
  CheckBoxFLIGHT_MODES = new wxCheckBox(Panel2, ID_CHECKBOX18, _("Flight modes"), wxPoint(512,200), wxSize(120,16), 0, wxDefaultValidator, _T("ID_CHECKBOX18"));
  CheckBoxFLIGHT_MODES->SetValue(false);
  CheckBoxFLIGHT_MODES->SetToolTip(_("Option phases de vol"));
  CheckBoxCURVES = new wxCheckBox(Panel2, ID_CHECKBOX19, _("Curves"), wxPoint(512,248), wxSize(120,16), 0, wxDefaultValidator, _T("ID_CHECKBOX19"));
  CheckBoxCURVES->SetValue(false);
  CheckBoxCURVES->SetToolTip(_("Option courbes"));
  CheckBoxGVARS = new wxCheckBox(Panel2, ID_CHECKBOX20, _("Global vars"), wxPoint(512,224), wxSize(120,16), 0, wxDefaultValidator, _T("ID_CHECKBOX20"));
  CheckBoxGVARS->SetValue(false);
  CheckBoxGVARS->SetToolTip(_("Option variables globales"));
  CheckBoxSPLASH = new wxCheckBox(Panel2, ID_CHECKBOX21, _("Écran d\'accueil"), wxPoint(320,216), wxSize(112,16), 0, wxDefaultValidator, _T("ID_CHECKBOX21"));
  CheckBoxSPLASH->SetValue(false);
  CheckBoxSPLASH->SetToolTip(_("Ecran d\'accueil"));
  ChoiceFONT = new wxChoice(Panel2, ID_CHOICE11, wxPoint(320,176), wxSize(56,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE11"));
  ChoiceFONT->SetSelection( ChoiceFONT->Append(_("STD")) );
  ChoiceFONT->Append(_("SQT5"));
  ChoiceFONT->SetToolTip(_("Police de caractére"));
  StaticText10 = new wxStaticText(Panel2, ID_STATICTEXT10, _("Font"), wxPoint(224,184), wxSize(88,16), wxALIGN_RIGHT, _T("ID_STATICTEXT10"));
  CheckBoxBOLD = new wxCheckBox(Panel2, ID_CHECKBOX40, _("Bold"), wxPoint(320,112), wxSize(112,16), 0, wxDefaultValidator, _T("ID_CHECKBOX40"));
  CheckBoxBOLD->SetValue(false);
  CheckBoxBOLD->SetToolTip(_("Vrai police en gras"));
  CheckBoxBATTGRAPH = new wxCheckBox(Panel2, ID_CHECKBOX41, _("Batt graph"), wxPoint(320,144), wxSize(112,16), 0, wxDefaultValidator, _T("ID_CHECKBOX41"));
  CheckBoxBATTGRAPH->SetValue(false);
  CheckBoxBATTGRAPH->SetToolTip(_("Affichage graphique de l\'état de la batterie"));
  ChoiceFAI = new wxChoice(Panel2, ID_CHOICE13, wxPoint(512,112), wxSize(64,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE13"));
  ...
  ChoiceTHREE_POS = new wxChoice(Panel2, ID_CHOICE12, wxPoint(96,296), wxSize(96,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICE12"));
  ...
  CheckBoxInvStickLV = new wxCheckBox(Panel2, ID_CHECKBOX4, _("Inversion Stick_LV"), wxPoint(656,80), wxSize(112,16), 0, wxDefaultValidator, _T("ID_CHECKBOX4"));
  CheckBoxInvStickLV->SetValue(false);
  CheckBoxInvStickRV = new wxCheckBox(Panel2, ID_CHECKBOX2, _("Inversion Stick_RV"), wxPoint(656,56), wxSize(112,16), 0, wxDefaultValidator, _T("ID_CHECKBOX2"));
  CheckBoxInvStickRV->SetValue(false);
  CheckBoxLCDROT180 = new wxCheckBox(Panel2, ID_CHECKBOX9, _("Rotation Lcd 180°"), wxPoint(96,112), wxSize(104,16), 0, wxDefaultValidator, _T("ID_CHECKBOX9"));
  ...
  StaticBox9 = new wxStaticBox(Panel3, ID_STATICBOX9, _("Beta test"), wxPoint(24,160), wxSize(144,176), 0, _T("ID_STATICBOX9"));
  ChoiceCC2500PAG = new wxChoice(Panel3, ID_CHOICECC2500PAG, wxPoint(112,215), wxSize(45,8), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICECC2500PAG"));
  ChoiceCC2500PAG->SetSelection( ChoiceCC2500PAG->Append(_("20")) );
  ChoiceCC2500PAG->Append(_("22"));
  ChoiceA7105PAG = new wxChoice(Panel3, ID_CHOICEA7105PAG, wxPoint(112,305), wxSize(45,8), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICEA7105PAG"));
  ChoiceA7105PAG->SetSelection( ChoiceA7105PAG->Append(_("20")) );
  ChoiceA7105PAG->Append(_("22"));
  ChoiceNRF24l01PAG = new wxChoice(Panel3, ID_CHOICENRF24l01PAG, wxPoint(112,275), wxSize(45,8), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICENRF24l01PAG"));
  ...
  StaticBox2 = new wxStaticBox(Panel3, ID_STATICBOX2, _("Télemetrie"), wxPoint(184,16), wxSize(136,320), 0, _T("ID_STATICBOX2"));
  ...
  CheckBoxCORRECT_NEGATIVE_VALUES = new wxCheckBox(Panel3, ID_CHECKBOX26, _("CORRECT_NEGATIVE_VALUES"), wxPoint(464,152), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX26"));
  ...
  CheckBoxARITHMETIC_OVERFLOW_CHECK = new wxCheckBox(Panel3, ID_CHECKBOX27, _("ARITHMETIC_OVERFLOW_CHECK"), wxPoint(464,184), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX27"));
  ...
  CheckBoxPWM_BACKLIGHT = new wxCheckBox(Panel3, ID_CHECKBOX30, _("PWM_BACKLIGHT"), wxPoint(464,56), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX30"));
  CheckBoxPWM_BACKLIGHT->SetValue(false);
  CheckBoxPWM_BACKLIGHT->Disable();
  CheckBoxOVERRIDE_CHANNEL_FUNCTION = new wxCheckBox(Panel3, ID_CHECKBOX31, _("Override channel function"), wxPoint(464,88), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX31"));
  ...
  CheckBoxTOGGLETRIM = new wxCheckBox(Panel3, ID_CHECKBOX36, _("Toggle trims"), wxPoint(464,120), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX36"));
  ...
  CheckBoxSHUTDOWN_CONFIRMATION = new wxCheckBox(Panel3, ID_CHECKBOX38, _("SHUTDOWN_CONFIRMATION"), wxPoint(464,248), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX38"));
  CheckBoxSHUTDOWN_CONFIRMATION->SetValue(true);
  CheckBoxSHUTDOWN_CONFIRMATION->Disable();
  CheckBoxACCURAT_THROTTLE_STATS = new wxCheckBox(Panel3, ID_CHECKBOX39, _("ACCURAT_THROTTLE_STATS"), wxPoint(464,216), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX39"));
  ...
  CheckBoxCC2500 = new wxCheckBox(Panel3, ID_CHECKBOX23, _("CC2500"), wxPoint(36,220), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX23"));
  CheckBoxCC2500->SetValue(false);
  CheckBoxCYRF6936 = new wxCheckBox(Panel3, ID_CHECKBOX24, _("CYRF6936"), wxPoint(36,250), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX24"));
  CheckBoxCYRF6936->SetValue(false);
  CheckBoxNRF24l01 = new wxCheckBox(Panel3, ID_CHECKBOX25, _("NRF24l01"), wxPoint(36,280), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX25"));
  CheckBoxNRF24l01->SetValue(false);
  CheckBoxA7105 = new wxCheckBox(Panel3, ID_CHECKBOX29, _("A7105"), wxPoint(36,310), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX29"));
  CheckBoxA7105->SetValue(false);
  ChoiceCYRF6936PAG = new wxChoice(Panel3, ID_CHOICECYRF6936PAG, wxPoint(112,245), wxSize(45,8), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICECYRF6936PAG"));
  ...
  CheckBoxBLUETOOTH = new wxCheckBox(Panel3, ID_CHECKBOX33, _("BLUETOOTH"), wxPoint(336,248), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX33"));
  CheckBoxBLUETOOTH->SetValue(false);
  CheckBoxBLUETOOTH->SetToolTip(_("Ajout de fonctions sans fils"));
  CheckBoxXMODEM = new wxCheckBox(Panel3, ID_CHECKBOX34, _("XMODEM"), wxPoint(670,56), wxDefaultSize, 0, wxDefaultValidator, _T("ID_CHECKBOX34"));
  ...
  StaticBox11 = new wxStaticBox(Panel5, ID_STATICBOX11, _("X-Any Options"), wxPoint(16,16), wxSize(280,304), 0, _T("ID_STATICBOX11"));
  Button1 = new wxButton(Panel5, ID_BUTTON8, _("Sauvegarder et sortir"), wxPoint(448,88), wxSize(168,23), 0, wxDefaultValidator, _T("ID_BUTTON8"));
  Button2 = new wxButton(Panel5, ID_BUTTON9, _("Compiler"), wxPoint(472,200), wxSize(136,23), 0, wxDefaultValidator, _T("ID_BUTTON9"));
  ChoiceNUMXANY = new wxChoice(Panel5, ID_CHOICENUMXANY, wxPoint(128,48), wxSize(56,21), 0, 0, 0, wxDefaultValidator, _T("ID_CHOICENUMXANY"));
