...
CompilerOptionsFrame::CompilerOptionsFrame(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
  ...
  CheckBoxPPM_LIMITS_SYMETRICAL = new wxCheckBox(Panel2, ID_CHECKBOX17, _("PPM Simm limits"), wxPoint(512,296), wxSize(120,24), 0, wxDefaultValidator, _T("ID_CHECKBOX17"));
  ...
  CheckBoxPPM_CENTER_ADJUSTABLE = new wxCheckBox(Panel2, ID_CHECKBOX16, _("PPM Center adjust"), wxPoint(512,272), wxSize(120,24), 0, wxDefaultValidator, _T("ID_CHECKBOX16"));
  ...
  CheckBoxHELI = new wxCheckBox(Panel2, ID_CHECKBOX1, _("HELI"), wxPoint(512,152), wxSize(120,24), 0, wxDefaultValidator, _T("ID_CHECKBOX1"));
  CheckBoxHELI->SetValue(false);
  CheckBoxHELI->SetToolTip(_("Option hélicoptère"));
  CheckBoxTEMPLATES = new wxCheckBox(Panel2, ID_CHECKBOX15, _("TEMPLATES"), wxPoint(512,176), wxSize(120,24), 0, wxDefaultValidator, _T("ID_CHECKBOX15"));
  ...
  CheckBoxFLIGHT_MODES = new wxCheckBox(Panel2, ID_CHECKBOX18, _("Flight modes"), wxPoint(512,200), wxSize(120,24), 0, wxDefaultValidator, _T("ID_CHECKBOX18"));
  CheckBoxFLIGHT_MODES->SetValue(false);
  CheckBoxFLIGHT_MODES->SetToolTip(_("Option phases de vol"));
  CheckBoxCURVES = new wxCheckBox(Panel2, ID_CHECKBOX19, _("Curves"), wxPoint(512,248), wxSize(120,24), 0, wxDefaultValidator, _T("ID_CHECKBOX19"));
  CheckBoxCURVES->SetValue(false);
  CheckBoxCURVES->SetToolTip(_("Option courbes"));
  CheckBoxGVARS = new wxCheckBox(Panel2, ID_CHECKBOX20, _("Global vars"), wxPoint(512,224), wxSize(120,24), 0, wxDefaultValidator, _T("ID_CHECKBOX20"));
  ...
  StaticBox3 = new wxStaticBox(Panel3, ID_STATICBOX3, _("Autres paramètres"), wxPoint(296,8), wxSize(480,256), 0, _T("ID_STATICBOX3"));
  ...
  CheckBoxNOANDSECONDE = new wxCheckBox(Panel3, ID_CHECKBOXNOANDSECONDE, _("NOANDSECONDE"), wxPoint(304,160), wxSize(112,24), 0, wxDefaultValidator, _T("ID_CHECKBOXNOANDSECONDE"));
  ...
  StaticBox2 = new wxStaticBox(Panel3, ID_STATICBOX2, _("Télemetrie"), wxPoint(168,8), wxSize(120,328), 0, _T("ID_STATICBOX2"));
  ...
  CheckBoxCORRECT_NEGATIVE_VALUES = new wxCheckBox(Panel3, ID_CHECKBOX26, _("CORRECT_NEGATIVE_VALUES"), wxPoint(416,128), wxSize(184,24), 0, wxDefaultValidator, _T("ID_CHECKBOX26"));
  ...
  CheckBoxARITHMETIC_OVERFLOW_CHECK = new wxCheckBox(Panel3, ID_CHECKBOX27, _("ARITHMETIC_OVERFLOW_CHECK"), wxPoint(416,160), wxSize(184,24), 0, wxDefaultValidator, _T("ID_CHECKBOX27"));
  ...
  CheckBoxPWM_BACKLIGHT = new wxCheckBox(Panel3, ID_CHECKBOX30, _("PWM_BACKLIGHT"), wxPoint(416,32), wxSize(184,24), 0, wxDefaultValidator, _T("ID_CHECKBOX30"));
  CheckBoxPWM_BACKLIGHT->SetValue(false);
  CheckBoxPWM_BACKLIGHT->Disable();
  CheckBoxOVERRIDE_CHANNEL_FUNCTION = new wxCheckBox(Panel3, ID_CHECKBOX31, _("Override channel function"), wxPoint(416,64), wxSize(184,24), 0, wxDefaultValidator, _T("ID_CHECKBOX31"));
  ...
  CheckBoxWS_HOW_HIGH = new wxCheckBox(Panel3, ID_CHECKBOX32, _("WS_HOW_HIGH"), wxPoint(184,64), wxSize(96,24), 0, wxDefaultValidator, _T("ID_CHECKBOX32"));
  CheckBoxWS_HOW_HIGH->SetValue(false);
  CheckBoxWS_HOW_HIGH->SetToolTip(_("WS HowHigh Altimeter"));
  CheckBoxTOGGLETRIM = new wxCheckBox(Panel3, ID_CHECKBOX36, _("Toggle trims"), wxPoint(416,96), wxSize(184,24), 0, wxDefaultValidator, _T("ID_CHECKBOX36"));
  ...
  CheckBoxFRAM = new wxCheckBox(Panel3, ID_CHECKBOX37, _("F-RAM"), wxPoint(304,192), wxSize(112,24), 0, wxDefaultValidator, _T("ID_CHECKBOX37"));
  CheckBoxFRAM->SetValue(false);
  CheckBoxFRAM->SetToolTip(_("Utilisation d\'une eeprom externe : FM24W256"));
  CheckBoxSHUTDOWN_CONFIRMATION = new wxCheckBox(Panel3, ID_CHECKBOX38, _("SHUTDOWN_CONFIRMATION"), wxPoint(416,224), wxSize(184,24), 0, wxDefaultValidator, _T("ID_CHECKBOX38"));
  CheckBoxSHUTDOWN_CONFIRMATION->SetValue(true);
  CheckBoxSHUTDOWN_CONFIRMATION->Disable();
  CheckBoxACCURAT_THROTTLE_STATS = new wxCheckBox(Panel3, ID_CHECKBOX39, _("ACCURAT_THROTTLE_STATS"), wxPoint(416,192), wxSize(184,24), 0, wxDefaultValidator, _T("ID_CHECKBOX39"));
  CheckBoxACCURAT_THROTTLE_STATS->SetValue(false);
  CheckBoxEEPROM_PROGRESS_BAR = new wxCheckBox(Panel3, ID_CHECKBOX43, _("EEPROM bar"), wxPoint(304,96), wxSize(112,24), 0, wxDefaultValidator, _T("ID_CHECKBOX43"));
  ...
  CheckBoxAUTOSWITCH = new wxCheckBox(Panel3, ID_CHECKBOX44, _("AUTOSWITCH"), wxPoint(304,64), wxSize(112,24), 0, wxDefaultValidator, _T("ID_CHECKBOX44"));
  CheckBoxAUTOSWITCH->SetValue(false);
  CheckBoxAUTOSWITCH->SetToolTip(_("Auto detection des switchs lors de la programmatiion"));
  CheckBoxAUTOSOURCE = new wxCheckBox(Panel3, ID_CHECKBOX45, _("AUTOSOURCE"), wxPoint(304,32), wxSize(112,24), 0, wxDefaultValidator, _T("ID_CHECKBOX45"));
  ...
  CheckBoxDBLKEYS = new wxCheckBox(Panel3, ID_CHECKBOX47, _("Double keys"), wxPoint(304,128), wxSize(112,24), 0, wxDefaultValidator, _T("ID_CHECKBOX47"));
  ...
  CheckBoxBLUETOOTH = new wxCheckBox(Panel3, ID_CHECKBOX33, _("BLUETOOTH"), wxPoint(304,224), wxSize(112,24), 0, wxDefaultValidator, _T("ID_CHECKBOX33"));
  CheckBoxBLUETOOTH->SetValue(false);
  CheckBoxBLUETOOTH->SetToolTip(_("Ajout de fonctions sans fils"));
  CheckBoxXMODEM = new wxCheckBox(Panel3, ID_CHECKBOX34, _("XMODEM"), wxPoint(600,32), wxSize(168,24), 0, wxDefaultValidator, _T("ID_CHECKBOX34"));
