...
//SUPIIIK FILE
  ...
  #define RF_CS_CC2500_ACTIVE() PORTH &= ~(OUT_J_CC2500_CS_N)
  #define RF_CS_CC2500_INACTIVE() PORTH |= (OUT_J_CC2500_CS_N)
  #define RF_CS_CYRF6936_ACTIVE() PORTG &= ~(OUT_J_CYRF6936_CS_N)
  #define RF_CS_CYRF6936_INACTIVE() PORTG |= (OUT_J_CYRF6936_CS_N)
  #define RF_CS_NRF24L01_ACTIVE() PORTG &= ~(OUT_J_NRF24L01_CS_N)
  #define RF_CS_NRF24L01_INACTIVE() PORTG |= (OUT_J_NRF24L01_CS_N)
  #define RF_CS_A7105_ACTIVE() PORTG &= ~(OUT_J_A7105_CS_N)
  #define RF_CS_A7105_INACTIVE() PORTG |= (OUT_J_A7105_CS_N)
