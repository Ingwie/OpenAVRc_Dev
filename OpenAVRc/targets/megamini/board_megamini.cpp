...
FORCEINLINE void boardInit()
{
  ...
  DDRD = 0b00001000;  PORTD = 0b11111111; // 7:AilDR_SW, 6:N/A, 5:N/A, 4:PPM_IN, 3:BT_TX, 2:BT_RX, 1:I2C_SDA, 0:I2C_SCL
  DDRE = 0b00000010;  PORTE = 0b11111111; // 7:Rot_2A, 6:Rot_2B, 5:Rot_1B, 4:Rot_1A, 3:Rot_2_Push, 2:N/A, 1:TELEM_TX, 0:TELEM_RX
  ...
  DDRJ = 0b01111010;  PORTJ = 0b11111111; // 7:BT_STATUS, 6:CS_A7105, 5:CS_NRF24L01, 4:CS_CYRF6936, 3:CS_CC2500, 2:SCC, 1:JQ6500Data , 0:JQ6500Busy
