 ...
 * No Reset signal as that is derived from RTC chip / board.
 *****************************************************************
*/
...
#define ST7565R_CMD_VOLTAGE_RESISTOR_RATIO_5dec5    0x25
...
#define PORT_SPI_bm  0x20  /* SPI bit mask. */
 ...
 _delay_us(300);
 lcdSendCtl(ST7565R_CMD_VOLTAGE_RESISTOR_RATIO_5dec5);
 ...
 lcdSendCtl(CONTRAST_MIN);// See above ... 0 = 0x11
