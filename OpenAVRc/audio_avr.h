...
#define PLAY_MODEL_NAME()        VOICE_AUDIO_BUZZER(PUSH_CUSTOM_PROMPT(AU_MODEL_NAME_NUM_FILE); PUSH_CUSTOM_PROMPT(AU_MODEL_NAME_NUM_FILE + 1 + g_eeGeneral.currModel),,)
...
#define PLAY_PUPPY_GET()         VOICE_AUDIO_BUZZER(PUSH_SYSTEM_PROMPT(AU_PUPPY_GET),,)
#define PLAY_PUPPY_LOSS()        VOICE_AUDIO_BUZZER(PUSH_SYSTEM_PROMPT(AU_PUPPY_LOSS),,)
