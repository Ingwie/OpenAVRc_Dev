...
#define TR_MULTI_FIXEDID               "ID Fijo"
#define TR_MULTI_MAX_THROW             "Máx. Throw"
#define TR_MULTI_RFCHAN                "Canal RF"
#define TR_MULTI_OUTPUT                "salida"
...
#define TR_VTELPROTO           "Nada\0  ""Hub\0   ""WSHHigh""S.Port\0""iBus\0  "
...
#if defined(SCC)
  #define TR_SCC                            "CAMBIADOR DE CANAL"
  #define TR_SCC_CURCHANNELLBL              "Canal actual"
  #define TR_SCC_NEWCHANNELLBL              "Canal solicitado"
  #define TR_SCC_SBUSSWEEPTESTLBL           "Barrido de SBus"
#endif
