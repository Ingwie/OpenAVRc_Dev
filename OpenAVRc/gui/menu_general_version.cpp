 ...
 for (uint8_t j=0; j<4; j++)
  {
   ...
   lcd_outhex(2, ID_OFFSET + j*2*FW, 7*FH, g_eeGeneral.fixed_ID.ID_8[3-j], rowattr);
   if (rowattr && (s_editMode>0 || p1valdiff)) CHECK_INCDEC_GENVAR(event, g_eeGeneral.fixed_ID.ID_8[3-j], 0, 0xFF);
  }
}
