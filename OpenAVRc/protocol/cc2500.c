...
#if (CC2500PA_GAIN == 20)
  const static uint16_t zzCC2500_Powers[] PROGMEM = {0,100,1000,1585,3981,6310,10000,12589};
#endif
#if (CC2500PA_GAIN == 22)
  const static uint16_t zzCC2500_Powers[] PROGMEM = {0,158,1585,2512,6310,10000,15849,19953};
#endif

  uint8_t cc2500_patable;
