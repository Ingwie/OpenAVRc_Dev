...
#else
//definition : PROTODEF(proto, module, map, init, name) proto,

// PB6 out
PROTODEF(PROTOCOL_PPM_BB,    MULTIMOD,  NULL, PPM_BB_Cmds, "BitBang/n")
PROTODEF(PROTOCOL_PPM_SWITCHING,    MULTIMOD,  NULL, PPM_SWITCHING_Cmds, " HW_PPM/n")
...
//PROTODEF(PROTOCOL_FRSKY2WAY, CC2500, AETRG, FRSKY2WAY_Cmds, const pm_char STR_FRSKY_D[] PROGMEM = "FrSky-D")
PROTODEF(PROTOCOL_FRSKYV, CC2500, AETRG, FRSKYV_Cmds, "FrSky-V8/n")
PROTODEF(PROTOCOL_SKYARTEC, CC2500, AETRG, SKYARTEC_Cmds, "Skyartec/n")
