...
PROTODEF(PROTOCOL_PPM, MULTIMOD, NULL, PROTO_PPM_Cmds, STR_PPM ,const pm_char STR_PPM[] PROGMEM = "PPM     ")
PROTODEF(PROTOCOL_PPM16, MULTIMOD, NULL, PROTO_PPM16_Cmds, STR_PPM16 ,const pm_char STR_PPM16[] PROGMEM = "PPM16   ")
PROTODEF(PROTOCOL_PPMSIM, MULTIMOD, NULL, PROTO_PPMSIM_Cmds, STR_PPMSIM ,const pm_char STR_PPMSIM[] PROGMEM = "PPMSIM  ")
#ifdef DSM2_SERIAL
PROTODEF(PROTOCOL_DSM_SERIAL, NULL, AETRG, DSM_SERIAL_Cmds, STR_DSM_SERIAL, const pm_char STR_DSM_SERIAL[] PROGMEM = "DSM-SERI")
#endif

#ifdef PROTO_HAS_MULTISUPIIIK
PROTODEF(PROTOCOL_MULTI, NULL, AETRG, MULTI_Cmds, STR_MULTI ,const pm_char STR_MULTI[] PROGMEM = "MultiMod")
#endif
...
PROTODEF(PROTOCOL_FRSKYX, CC2500, AETRG, FRSKYX_Cmds, STR_FRSKYX, const pm_char STR_FRSKYX[] PROGMEM = "FrSky-X ")
PROTODEF(PROTOCOL_SKYARTEC, CC2500, AETRG, SKYARTEC_Cmds, STR_SKYARTEC ,const pm_char STR_SKYARTEC[] PROGMEM = "Skyartec")
PROTODEF(PROTOCOL_CORONA, CC2500, AETRG, CORONA_Cmds, STR_CORONA ,const pm_char STR_CORONA[] PROGMEM = "Corona")
