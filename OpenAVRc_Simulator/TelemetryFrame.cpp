...
TelemetryFrame::TelemetryFrame(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
  ...
  StaticBox5 = new wxStaticBox(Panel1, ID_STATICBOX5, _("Cap"), wxPoint(552,32), wxSize(80,64), 0, _T("ID_STATICBOX5"));
  ...
  RBFrskyd = new wxRadioButton(Panel1, ID_RADIOBUTTON2, _("Frsky \"D\""), wxPoint(816,136), wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON2"));
  RBFrskysport = new wxRadioButton(Panel1, ID_RADIOBUTTON1, _("Frsky S.Port"), wxPoint(816,160), wxDefaultSize, 0, wxDefaultValidator, _T("ID_RADIOBUTTON1"));
