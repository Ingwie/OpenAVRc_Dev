...
OutBarsFrame::OutBarsFrame(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	output1 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL1, _("Texte"), wxPoint(216,10), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL1"));
	output2 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL2, _("Texte"), wxPoint(216,26), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL2"));
	output3 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL3, _("Texte"), wxPoint(216,42), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL3"));
	output4 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL4, _("Texte"), wxPoint(216,58), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL4"));
	output5 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL5, _("Texte"), wxPoint(216,74), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL5"));
	output6 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL6, _("Texte"), wxPoint(216,90), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL6"));
	output7 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL7, _("Texte"), wxPoint(216,106), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL7"));
	output8 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL8, _("Texte"), wxPoint(216,122), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL8"));
	output9 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL9, _("Texte"), wxPoint(216,138), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL9"));
	output10 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL10, _("Texte"), wxPoint(216,154), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL10"));
	output11 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL11, _("Texte"), wxPoint(216,170), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL11"));
	output12 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL12, _("Texte"), wxPoint(216,186), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL12"));
	output13 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL13, _("Texte"), wxPoint(216,202), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL13"));
	output14 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL14, _("Texte"), wxPoint(216,218), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL14"));
	output15 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL15, _("Texte"), wxPoint(216,234), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL15"));
	output16 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL16, _("Texte"), wxPoint(216,250), wxSize(48,16), wxTE_READONLY|wxTE_RICH|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL16"));
