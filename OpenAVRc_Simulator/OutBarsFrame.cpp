...
OutBarsFrame::OutBarsFrame(wxWindow* parent,wxWindowID id,const wxPoint& pos,const wxSize& size)
{
	...
	SetClientSize(wxSize(274,288));
	Move(wxPoint(40,40));
	PanelOutputSliders = new wxPanel(this, ID_PANELOUTPUTSLIDEERS, wxDefaultPosition, wxSize(272,296), 0, _T("ID_PANELOUTPUTSLIDEERS"));
	output1 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL1, _("Texte"), wxPoint(208,10), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL1"));
	output2 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL2, _("Texte"), wxPoint(208,26), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL2"));
	output3 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL3, _("Texte"), wxPoint(208,42), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL3"));
	output4 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL4, _("Texte"), wxPoint(208,58), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL4"));
	output5 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL5, _("Texte"), wxPoint(208,74), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL5"));
	output6 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL6, _("Texte"), wxPoint(208,90), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL6"));
	output7 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL7, _("Texte"), wxPoint(208,106), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL7"));
	output8 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL8, _("Texte"), wxPoint(208,122), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL8"));
	output9 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL9, _("Texte"), wxPoint(208,138), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL9"));
	output10 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL10, _("Texte"), wxPoint(208,154), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL10"));
	output11 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL11, _("Texte"), wxPoint(208,170), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL11"));
	output12 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL12, _("Texte"), wxPoint(208,186), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL12"));
	output13 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL13, _("Texte"), wxPoint(208,202), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL13"));
	output14 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL14, _("Texte"), wxPoint(208,218), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL14"));
	output15 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL15, _("Texte"), wxPoint(208,234), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL15"));
	output16 = new wxTextCtrl(PanelOutputSliders, ID_TEXTCTRL16, _("Texte"), wxPoint(208,250), wxSize(56,16), wxTE_READONLY|wxTE_RICH|wxBORDER_NONE|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_TEXTCTRL16"));
	StaticText1 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT1, _("Ch1"), wxPoint(8,13), wxSize(40,16), 0, _T("ID_STATICTEXT1"));
	StaticText2 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT2, _("Ch2"), wxPoint(8,29), wxSize(40,16), 0, _T("ID_STATICTEXT2"));
	StaticText3 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT3, _("Ch3"), wxPoint(8,45), wxSize(40,16), 0, _T("ID_STATICTEXT3"));
	StaticText4 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT4, _("Ch4"), wxPoint(8,61), wxSize(40,16), 0, _T("ID_STATICTEXT4"));
	StaticText5 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT5, _("Ch5"), wxPoint(8,77), wxSize(40,16), 0, _T("ID_STATICTEXT5"));
	StaticText6 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT6, _("Ch6"), wxPoint(8,93), wxSize(40,16), 0, _T("ID_STATICTEXT6"));
	StaticText7 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT7, _("Ch7"), wxPoint(8,109), wxSize(40,16), 0, _T("ID_STATICTEXT7"));
	StaticText8 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT8, _("Ch8"), wxPoint(8,125), wxSize(40,16), 0, _T("ID_STATICTEXT8"));
	StaticText9 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT9, _("Ch9"), wxPoint(8,141), wxSize(40,16), 0, _T("ID_STATICTEXT9"));
	StaticText10 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT10, _("Ch10"), wxPoint(8,157), wxSize(40,16), 0, _T("ID_STATICTEXT10"));
	StaticText11 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT11, _("Ch11"), wxPoint(8,173), wxSize(40,16), 0, _T("ID_STATICTEXT11"));
	StaticText12 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT12, _("Ch12"), wxPoint(8,189), wxSize(40,16), 0, _T("ID_STATICTEXT12"));
	StaticText13 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT13, _("Ch13"), wxPoint(8,205), wxSize(40,16), 0, _T("ID_STATICTEXT13"));
	StaticText14 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT14, _("Ch14"), wxPoint(8,221), wxSize(40,16), 0, _T("ID_STATICTEXT14"));
	StaticText15 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT15, _("Ch15"), wxPoint(8,237), wxSize(40,16), 0, _T("ID_STATICTEXT15"));
	StaticText16 = new wxStaticText(PanelOutputSliders, ID_STATICTEXT16, _("Ch16"), wxPoint(8,253), wxSize(40,16), 0, _T("ID_STATICTEXT16"));
