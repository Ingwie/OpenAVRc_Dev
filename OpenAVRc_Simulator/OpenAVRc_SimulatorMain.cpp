...
const wxWindowID OpenAVRc_SimulatorFrame::ID_PANELH = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_POT1 = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_POT2 = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_POT3 = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPMENU = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPH = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPEXIT = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_LLTRIM = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_LUTRIM = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_LDTRIM = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_RDTRIM = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_RUTRIM = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_RLTRIM = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_RRTRIM = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_LRTRIM = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPG = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPB = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPD = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_RSTICK = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPTHR = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPRUD = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPELE = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPTRN = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPAIL = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPGEA = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_PBID1 = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BOID2 = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_LSTICK = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_SPINREA = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_SPINREB = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_TEXTCTRLDUMMY = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPREA = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BPREB = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_SIMULCD = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_PANELMAIN = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_ONTGLBUTTON = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BUTTONSTARTDESKTOP = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_CHECKBOXA7105 = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_CHECKBOXNRF24L01 = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_CHECKBOXCC2500 = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_CHECKBOXCYRF6936 = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_CHECKBOXMULTIMOD = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_CHECKBOXSERPROTO = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_STATICTEXT1 = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_STATICTEXTEEPATH = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_PANELL = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_PANELPRINCIPAL = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::IdMenuOpenEE = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::IdMenuSaveEE = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::IDMENUEXPORTEEPROM = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::IDMENUIMPORTEEPROM = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::idMenuQuit = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_LCDB = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_LCDF = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BUTOFF = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_BUTON = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_STICKB = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_STICKF = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_COLOURS = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_MENUITEMOUTPUTMIXER = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_MENUITEMOUTPUTOUTPUT = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_MENUITEMOUTPUTGVARS = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_MENUITEMRADIODATA = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_MENUITEMTELEMETRY = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_MENUITEMLOGS = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_MENUITEMUCLI = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::idMenuAbout = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_STATUSBAR = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_TIMER10MS = wxNewId();
const wxWindowID OpenAVRc_SimulatorFrame::ID_TIMERMAIN = wxNewId();
//*)
...
OpenAVRc_SimulatorFrame::OpenAVRc_SimulatorFrame(wxWindow* parent,wxWindowID id)
{
  ...
  BPmenu->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPmenuLeftDown, NULL, this);
  BPmenu->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPmenuLeftUp, NULL, this);
  BPh->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPhLeftDown, NULL, this);
  BPh->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPhLeftUp, NULL, this);
  BPexit->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPexitLeftDown, NULL, this);
  BPexit->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPexitLeftUp, NULL, this);
  LlTrim->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLlTrimLeftDown, NULL, this);
  LlTrim->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLlTrimLeftUp, NULL, this);
  LuTrim->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLuTrimLeftDown, NULL, this);
  LuTrim->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLuTrimLeftUp, NULL, this);
  LdTrim->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLdTrimLeftDown, NULL, this);
  LdTrim->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLdTrimLeftUp, NULL, this);
  RdTrim->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRdTrimLeftDown, NULL, this);
  RdTrim->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRdTrimLeftUp, NULL, this);
  RuTrim->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRuTrimLeftDown, NULL, this);
  RuTrim->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRuTrimLeftUp, NULL, this);
  RlTrim->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRlTrimLeftDown, NULL, this);
  RlTrim->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRlTrimLeftUp, NULL, this);
  RrTrim->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRrTrimLeftDown, NULL, this);
  RrTrim->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRrTrimLeftUp, NULL, this);
  LrTrim->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLrTrimLeftDown, NULL, this);
  LrTrim->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLrTrimLeftUp, NULL, this);
  BPg->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPgLeftDown, NULL, this);
  BPg->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPgLeftUp, NULL, this);
  BPb->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPbLeftDown, NULL, this);
  BPb->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPbLeftUp, NULL, this);
  BPd->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPdLeftDown, NULL, this);
  BPd->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBPdLeftUp, NULL, this);
  Rstick->Connect(wxEVT_PAINT, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRstickPaint, NULL, this);
  Rstick->Connect(wxEVT_KEY_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnPanelMainKeyDown, NULL, this);
  Rstick->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRstickMouseMove, NULL, this);
  Rstick->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRstickLeftUp, NULL, this);
  Rstick->Connect(wxEVT_MOTION, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRstickMouseMove, NULL, this);
  Rstick->Connect(wxEVT_LEAVE_WINDOW, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnRstickLeftUp, NULL, this);
  BpThr->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpThrLeftDown, NULL, this);
  BpRud->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpRudLeftDown, NULL, this);
  BpEle->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpEleLeftDown, NULL, this);
  BpTrn->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpTrnLeftDown, NULL, this);
  BpTrn->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpTrnLeftUp, NULL, this);
  BpTrn->Connect(wxEVT_RIGHT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpTrnRightDown, NULL, this);
  BpAil->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpAilLeftDown, NULL, this);
  BpGea->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpGeaLeftDown, NULL, this);
  BpId1->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpId1LeftDown, NULL, this);
  BpId2->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpId2LeftDown, NULL, this);
  Lstick->Connect(wxEVT_PAINT, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLstickPaint, NULL, this);
  Lstick->Connect(wxEVT_KEY_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnPanelMainKeyDown, NULL, this);
  Lstick->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLstickMouseMove, NULL, this);
  Lstick->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLstickLeftUp, NULL, this);
  Lstick->Connect(wxEVT_MOTION, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLstickMouseMove, NULL, this);
  Lstick->Connect(wxEVT_LEAVE_WINDOW, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnLstickLeftUp, NULL, this);
  BpRea->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpReaLeftDown, NULL, this);
  BpRea->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpReaLeftUp, NULL, this);
  BpReb->Connect(wxEVT_LEFT_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpRebLeftDown, NULL, this);
  BpReb->Connect(wxEVT_LEFT_UP, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnBpRebLeftUp, NULL, this);
  Simulcd->Connect(wxEVT_PAINT, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnwxsimulcdPaint, NULL, this);
  Simulcd->Connect(wxEVT_KEY_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnPanelMainKeyDown, NULL, this);
  Simulcd->Connect(wxEVT_LEFT_DCLICK, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnSimulcdLeftDClick, NULL, this);
  PanelMain->Connect(wxEVT_KEY_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnPanelMainKeyDown, NULL, this);
  ...
  PanelL->Connect(wxEVT_KEY_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnPanelMainKeyDown, NULL, this);
  PanelPrincipal->Connect(wxEVT_KEY_DOWN, (wxObjectEventFunction)&OpenAVRc_SimulatorFrame::OnPanelMainKeyDown, NULL, this);
...
{
  event.Skip();
  int answer = wxMessageBox( _("L'eeprom va Ä‚Âªtre formatée, étes vous sur ?"), _("    OpenAVRc Simulateur"), wxYES_NO, this);
  if (answer == wxNO) {
    return;
  }
  ImportEeprom();
