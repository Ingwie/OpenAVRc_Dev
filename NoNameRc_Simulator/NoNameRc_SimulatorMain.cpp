/***************************************************************
 * Name:      NoNameRc_SimulatorMain.cpp
...
//(*InternalHeaders(NoNameRc_SimulatorFrame)
...
//(*IdInit(NoNameRc_SimulatorFrame)
const long NoNameRc_SimulatorFrame::ID_PANELH = wxNewId();
const long NoNameRc_SimulatorFrame::ID_ONTGLBUTTON = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BUTTONSTARTDESKTOP = wxNewId();
const long NoNameRc_SimulatorFrame::ID_PANELL = wxNewId();
const long NoNameRc_SimulatorFrame::ID_POT1 = wxNewId();
const long NoNameRc_SimulatorFrame::ID_POT2 = wxNewId();
const long NoNameRc_SimulatorFrame::ID_POT3 = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPMENU = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPH = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPEXIT = wxNewId();
const long NoNameRc_SimulatorFrame::ID_LLTRIM = wxNewId();
const long NoNameRc_SimulatorFrame::ID_LUTRIM = wxNewId();
const long NoNameRc_SimulatorFrame::ID_LDTRIM = wxNewId();
const long NoNameRc_SimulatorFrame::ID_RDTRIM = wxNewId();
const long NoNameRc_SimulatorFrame::ID_RUTRIM = wxNewId();
const long NoNameRc_SimulatorFrame::ID_RLTRIM = wxNewId();
const long NoNameRc_SimulatorFrame::ID_RRTRIM = wxNewId();
const long NoNameRc_SimulatorFrame::ID_LRTRIM = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPG = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPB = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPD = wxNewId();
const long NoNameRc_SimulatorFrame::ID_RSTICK = wxNewId();
const long NoNameRc_SimulatorFrame::ID_SIMULCD = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPTHR = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPRUD = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPELE = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPTRN = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPAIL = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BPGEA = wxNewId();
const long NoNameRc_SimulatorFrame::ID_PBID1 = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BOID2 = wxNewId();
const long NoNameRc_SimulatorFrame::ID_LSTICK = wxNewId();
const long NoNameRc_SimulatorFrame::ID_SPINREA = wxNewId();
const long NoNameRc_SimulatorFrame::ID_SPINREB = wxNewId();
const long NoNameRc_SimulatorFrame::ID_TEXTCTRLDUMMY = wxNewId();
const long NoNameRc_SimulatorFrame::ID_PANELMAIN = wxNewId();
const long NoNameRc_SimulatorFrame::ID_PANELPRINCIPAL = wxNewId();
const long NoNameRc_SimulatorFrame::IdMenuOpenEE = wxNewId();
const long NoNameRc_SimulatorFrame::IdMenuSaveEE = wxNewId();
const long NoNameRc_SimulatorFrame::idMenuQuit = wxNewId();
const long NoNameRc_SimulatorFrame::ID_LCDB = wxNewId();
const long NoNameRc_SimulatorFrame::ID_LCDF = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BUTOFF = wxNewId();
const long NoNameRc_SimulatorFrame::ID_BUTON = wxNewId();
const long NoNameRc_SimulatorFrame::ID_STICKB = wxNewId();
const long NoNameRc_SimulatorFrame::ID_STICKF = wxNewId();
const long NoNameRc_SimulatorFrame::ID_COLOURS = wxNewId();
const long NoNameRc_SimulatorFrame::idMenuAbout = wxNewId();
const long NoNameRc_SimulatorFrame::ID_STATUSBAR = wxNewId();
const long NoNameRc_SimulatorFrame::ID_TIMER10MS = wxNewId();
const long NoNameRc_SimulatorFrame::ID_TIMERMAIN = wxNewId();
//*)

BEGIN_EVENT_TABLE(NoNameRc_SimulatorFrame,wxFrame)
    //(*EventTable(NoNameRc_SimulatorFrame)
    //*)
END_EVENT_TABLE()
...
NoNameRc_SimulatorFrame::NoNameRc_SimulatorFrame(wxWindow* parent,wxWindowID id)
{
    //(*Initialize(NoNameRc_SimulatorFrame)
    wxMenu* MenuHelp;
    ...
    Connect(ID_ONTGLBUTTON,wxEVT_COMMAND_TOGGLEBUTTON_CLICKED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnOnTglButtonToggle);
    Connect(ID_BUTTONSTARTDESKTOP,wxEVT_COMMAND_BUTTON_CLICKED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnButtonStartDesktopClick);
    BPmenu->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPmenuLeftDown,0,this);
    BPmenu->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPmenuLeftUp,0,this);
    BPh->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPhLeftDown,0,this);
    BPh->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPhLeftUp,0,this);
    BPexit->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPexitLeftDown,0,this);
    BPexit->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPexitLeftUp,0,this);
    LlTrim->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnLlTrimLeftDown,0,this);
    LlTrim->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnLlTrimLeftUp,0,this);
    LuTrim->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnLuTrimLeftDown,0,this);
    LuTrim->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnLuTrimLeftUp,0,this);
    LdTrim->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnLdTrimLeftDown,0,this);
    LdTrim->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnLdTrimLeftUp,0,this);
    RdTrim->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnRdTrimLeftDown,0,this);
    RdTrim->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnRdTrimLeftUp,0,this);
    RuTrim->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnRuTrimLeftDown,0,this);
    RuTrim->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnRuTrimLeftUp,0,this);
    RlTrim->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnRlTrimLeftDown,0,this);
    RlTrim->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnRlTrimLeftUp,0,this);
    RrTrim->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnRrTrimLeftDown,0,this);
    RrTrim->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnRrTrimLeftUp,0,this);
    LrTrim->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnLrTrimLeftDown,0,this);
    LrTrim->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnLrTrimLeftUp,0,this);
    BPg->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPgLeftDown,0,this);
    BPg->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPgLeftUp,0,this);
    BPb->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPbLeftDown,0,this);
    BPb->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPbLeftUp,0,this);
    BPd->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPdLeftDown,0,this);
    BPd->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBPdLeftUp,0,this);
    Rstick->Connect(wxEVT_PAINT,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnRstickPaint,0,this);
    Rstick->Connect(wxEVT_MOTION,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnRstickMouseMove,0,this);
    Simulcd->Connect(wxEVT_PAINT,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnwxsimulcdPaint,0,this);
    Simulcd->Connect(wxEVT_LEFT_DCLICK,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnSimulcdLeftDClick,0,this);
    BpThr->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBpThrLeftDown,0,this);
    BpRud->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBpRudLeftDown,0,this);
    BpEle->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBpEleLeftDown,0,this);
    BpTrn->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBpTrnLeftDown,0,this);
    BpTrn->Connect(wxEVT_LEFT_UP,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBpTrnLeftUp,0,this);
    BpTrn->Connect(wxEVT_RIGHT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBpTrnRightDown,0,this);
    BpAil->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBpAilLeftDown,0,this);
    BpGea->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBpGeaLeftDown,0,this);
    BpId1->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBpId1LeftDown,0,this);
    BpId2->Connect(wxEVT_LEFT_DOWN,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnBpId2LeftDown,0,this);
    Lstick->Connect(wxEVT_PAINT,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnLstickPaint,0,this);
    Lstick->Connect(wxEVT_MOTION,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnLstickMouseMove,0,this);
    Connect(IdMenuOpenEE,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnMenuLoadEeprom);
    Connect(IdMenuSaveEE,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnMenuSaveeeSelected);
    Connect(idMenuQuit,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnQuit);
    Connect(ID_LCDB,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnMenuLcdBackSelected);
    Connect(ID_LCDF,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnMenuLcdPixelSelected);
    Connect(ID_BUTOFF,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnMenuButOffSelected);
    Connect(ID_BUTON,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnMenuButOnSelected);
    Connect(ID_STICKB,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnMenuStickBackSelected);
    Connect(ID_STICKF,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnMenuStickStickSelected);
    Connect(idMenuAbout,wxEVT_COMMAND_MENU_SELECTED,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnAbout);
    Connect(ID_TIMER10MS,wxEVT_TIMER,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnTimer10msTrigger);
    Connect(ID_TIMERMAIN,wxEVT_TIMER,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnTimerMainTrigger);
    Connect(wxID_ANY,wxEVT_CLOSE_WINDOW,(wxObjectEventFunction)&NoNameRc_SimulatorFrame::OnClose);
    //*)
    {
        wxIcon FrameIcon;
    ...
    //Ini File
    Ini_Filename = wxStandardPaths::Get().GetUserConfigDir() + wxFileName::GetPathSeparator() + "NoNameRcSimulator.ini";
...
void NoNameRc_SimulatorFrame::OnOnTglButtonToggle(wxCommandEvent& event)
{
    int answer;
...
void NoNameRc_SimulatorFrame::StartFirmwareCode()
{
    simu_off = false;
...
void NoNameRc_SimulatorFrame::ResetSimu()
{
...
void NoNameRc_SimulatorFrame::OnTimerMainTrigger(wxTimerEvent& event) //1mS
{
    if (!OnTglButton->GetValue())
    {
        SpinH->ResetPin(6);
...
void NoNameRc_SimulatorFrame::OnTimer10msTrigger(wxTimerEvent& event)
{
    CheckInputs();
    Chrono10ms->Start(0);
    if (!simu_off)
...
const void NoNameRc_SimulatorFrame::DrawWxSimuLcd()
{
    uint8_t *p;
    p = displayBuf;
...
NoNameRc_SimulatorFrame::~NoNameRc_SimulatorFrame()
{
    //(*Destroy(NoNameRc_SimulatorFrame)
    //*)
}

void NoNameRc_SimulatorFrame::OnQuit(wxCommandEvent& event)
{
    Close();
}
...
void NoNameRc_SimulatorFrame::LoadEeprom()
{
...
void NoNameRc_SimulatorFrame::LoadEepromFile(wxString path)
{
...
void NoNameRc_SimulatorFrame::OnMenuLoadEeprom(wxCommandEvent& event)
{
    LoadEeprom();
}

void NoNameRc_SimulatorFrame::PaintSticks(int x, int y, int x_mem, int y_mem, wxPanel* stick)
{
...
void NoNameRc_SimulatorFrame::OnLstickMouseMove(wxMouseEvent& event)
{
...
void NoNameRc_SimulatorFrame::OnRstickMouseMove(wxMouseEvent& event)
{
...
void NoNameRc_SimulatorFrame::OnSimulcdLeftDClick(wxMouseEvent& event)
{
...
void NoNameRc_SimulatorFrame::OnMenuSaveeeSelected(wxCommandEvent& event)
{
...
void NoNameRc_SimulatorFrame::OnClose(wxCloseEvent& event)
{
...
void NoNameRc_SimulatorFrame::LoadConfig()
{
...
void NoNameRc_SimulatorFrame::SaveConfig()
{
...
void NoNameRc_SimulatorFrame::OnBPmenuLeftDown(wxMouseEvent& event)
{
    SpinL->ResetPin(4);
}

void NoNameRc_SimulatorFrame::OnBPmenuLeftUp(wxMouseEvent& event)
{
    SpinL->SetPin(4);
}

void NoNameRc_SimulatorFrame::OnBPexitLeftDown(wxMouseEvent& event)
{
    SpinL->ResetPin(5);
}

void NoNameRc_SimulatorFrame::OnBPexitLeftUp(wxMouseEvent& event)
{
    SpinL->SetPin(5);
}

void NoNameRc_SimulatorFrame::OnBPhLeftDown(wxMouseEvent& event)
{
    SpinL->ResetPin(1);
}

void NoNameRc_SimulatorFrame::OnBPhLeftUp(wxMouseEvent& event)
{
    SpinL->SetPin(1);
}

void NoNameRc_SimulatorFrame::OnBPbLeftDown(wxMouseEvent& event)
{
    SpinL->ResetPin(0);
}

void NoNameRc_SimulatorFrame::OnBPbLeftUp(wxMouseEvent& event)
{
    SpinL->SetPin(0);
}

void NoNameRc_SimulatorFrame::OnBPgLeftDown(wxMouseEvent& event)
{
    SpinL->ResetPin(3);
}

void NoNameRc_SimulatorFrame::OnBPgLeftUp(wxMouseEvent& event)
{
    SpinL->SetPin(3);
}

void NoNameRc_SimulatorFrame::OnBPdLeftDown(wxMouseEvent& event)
{
    SpinL->ResetPin(2);
}

void NoNameRc_SimulatorFrame::OnBPdLeftUp(wxMouseEvent& event)
{
    SpinL->SetPin(2);
}

void NoNameRc_SimulatorFrame::OnLlTrimLeftDown(wxMouseEvent& event)
{
    SpinF->ResetPin(7);
}

void NoNameRc_SimulatorFrame::OnLlTrimLeftUp(wxMouseEvent& event)
{
    SpinF->SetPin(7);
}

void NoNameRc_SimulatorFrame::OnLrTrimLeftDown(wxMouseEvent& event)
{
    SpinF->ResetPin(6);
}

void NoNameRc_SimulatorFrame::OnLrTrimLeftUp(wxMouseEvent& event)
{
    SpinF->SetPin(6);
}

void NoNameRc_SimulatorFrame::OnLdTrimLeftDown(wxMouseEvent& event)
{
    SpinF->ResetPin(5);
}

void NoNameRc_SimulatorFrame::OnLdTrimLeftUp(wxMouseEvent& event)
{
    SpinF->SetPin(5);
}

void NoNameRc_SimulatorFrame::OnLuTrimLeftDown(wxMouseEvent& event)
{
    SpinF->ResetPin(4);
}

void NoNameRc_SimulatorFrame::OnLuTrimLeftUp(wxMouseEvent& event)
{
    SpinF->SetPin(4);
}

void NoNameRc_SimulatorFrame::OnRdTrimLeftDown(wxMouseEvent& event)
{
    SpinF->ResetPin(3);
}

void NoNameRc_SimulatorFrame::OnRdTrimLeftUp(wxMouseEvent& event)
{
    SpinF->SetPin(3);
}

void NoNameRc_SimulatorFrame::OnRuTrimLeftDown(wxMouseEvent& event)
{
    SpinF->ResetPin(2);
}

void NoNameRc_SimulatorFrame::OnRuTrimLeftUp(wxMouseEvent& event)
{
    SpinF->SetPin(2);
}

void NoNameRc_SimulatorFrame::OnRlTrimLeftDown(wxMouseEvent& event)
{
    SpinF->ResetPin(1);
}

void NoNameRc_SimulatorFrame::OnRlTrimLeftUp(wxMouseEvent& event)
{
    SpinF->SetPin(1);
}

void NoNameRc_SimulatorFrame::OnRrTrimLeftDown(wxMouseEvent& event)
{
    SpinF->ResetPin(0);
}

void NoNameRc_SimulatorFrame::OnRrTrimLeftUp(wxMouseEvent& event)
{
    SpinF->SetPin(0);
}

void NoNameRc_SimulatorFrame::OnBpTrnLeftDown(wxMouseEvent& event)
{
    SpinL->ResetPin(7);
}

void NoNameRc_SimulatorFrame::OnBpTrnLeftUp(wxMouseEvent& event)
{
    SpinL->SetPin(7);
}

void NoNameRc_SimulatorFrame::OnBpTrnRightDown(wxMouseEvent& event)
{
    SpinL->ResetPin(7);
    CheckInputs();
}

void NoNameRc_SimulatorFrame::OnBpThrLeftDown(wxMouseEvent& event)
{
    SpinG->TogglePin(2);
}

void NoNameRc_SimulatorFrame::OnBpRudLeftDown(wxMouseEvent& event)
{
    SpinG->TogglePin(0);
}

void NoNameRc_SimulatorFrame::OnBpEleLeftDown(wxMouseEvent& event)
{
    SpinL->TogglePin(6);
}

void NoNameRc_SimulatorFrame::OnBpAilLeftDown(wxMouseEvent& event)
{
    SpinD->TogglePin(7);
}

void NoNameRc_SimulatorFrame::OnBpGeaLeftDown(wxMouseEvent& event)
{
    SpinG->TogglePin(1);
}

void NoNameRc_SimulatorFrame::OnBpId1LeftDown(wxMouseEvent& event)
{
    if (!SpinC->GetPin(1)) SpinC->TogglePin(1);
    else SpinC->TogglePin(0);
}

void NoNameRc_SimulatorFrame::OnBpId2LeftDown(wxMouseEvent& event)
{
    if (!SpinC->GetPin(0)) SpinC->TogglePin(0);
    else SpinC->TogglePin(1);
}

void NoNameRc_SimulatorFrame::CheckInputs()
{
    //Rea & Reb
...
wxColour NoNameRc_SimulatorFrame::SetColour()
{
...
void NoNameRc_SimulatorFrame::OnMenuLcdBackSelected(wxCommandEvent& event)
{
    Col_Lcd_Back = SetColour();
    DrawWxSimuLcd();
}

void NoNameRc_SimulatorFrame::OnMenuLcdPixelSelected(wxCommandEvent& event)
{
    Col_Lcd_Front = SetColour();
    DrawWxSimuLcd();
}

void NoNameRc_SimulatorFrame::OnMenuButOffSelected(wxCommandEvent& event)
{
    Col_Button_Off = SetColour();
}

void NoNameRc_SimulatorFrame::OnMenuButOnSelected(wxCommandEvent& event)
{
    Col_Button_On = SetColour();
}

void NoNameRc_SimulatorFrame::OnMenuStickBackSelected(wxCommandEvent& event)
{
...
void NoNameRc_SimulatorFrame::OnMenuStickStickSelected(wxCommandEvent& event)
{
...
void NoNameRc_SimulatorFrame::OnLstickPaint(wxPaintEvent& event)
{
    int pos = (Lstick->GetSize().GetWidth())/2;
    PaintSticks(pos,pos,pos,pos,Lstick);
}

void NoNameRc_SimulatorFrame::OnRstickPaint(wxPaintEvent& event)
{
...
void NoNameRc_SimulatorFrame::OnButtonStartDesktopClick(wxCommandEvent& event)
{
    wxString desktop("NoNameRc_Desktop.exe");
    wxExecute(desktop);
}

void NoNameRc_SimulatorFrame::OnKey(wxKeyEvent& event)
{
    wxMouseEvent fakevt;
