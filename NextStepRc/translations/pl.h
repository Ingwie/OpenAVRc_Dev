...
#define TR_ABOUT_nextsteprc_1      TR("nextsteprc\001is\001open\001source,\001non", "nextsteprc is open source, non-")
#define TR_ABOUT_nextsteprc_2      TR("commercial,\001wo\001warranties.", "commercial and comes with no")
#define TR_ABOUT_nextsteprc_3      TR("It\001was\001developed\001for\001free.", "warranties. It was developed")
#define TR_ABOUT_nextsteprc_4      TR("Support through donations", "for free. Support through")
#define TR_ABOUT_nextsteprc_5      TR("is welcome!", "donations is welcome!")

#define TR_ABOUT_BERTRAND_1    "Bertrand Songis"
#define TR_ABOUT_BERTRAND_2    "nextsteprc g\203\205wny autor"
