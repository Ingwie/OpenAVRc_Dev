...
#define TR_ABOUT_nextsteprc_1      TR("nextsteprc\001e'\001open\001source,\001non", "nextsteprc e' open source, non-")
#define TR_ABOUT_nextsteprc_2      TR("commercial,\001wo\001warranties.", "commerciale, fornito senza")
#define TR_ABOUT_nextsteprc_3      TR("It\001was\001developed\001for\001free.", "garanzie. E' stato sviluppato")
#define TR_ABOUT_nextsteprc_4      TR("Support through donations", "gratuitamente. Il supporto")
#define TR_ABOUT_nextsteprc_5      TR("is welcome!", "mediante donazioni e' gradito!")

#define TR_ABOUT_BERTRAND_1    "Bertrand Songis"
#define TR_ABOUT_BERTRAND_2    "Autore principale nextsteprc"
